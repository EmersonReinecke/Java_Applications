 ...
 * 
 * propriedades com valores, se isto se confirmar retorna o objeto cfg. Notem a
 * chamada ao método stringfy() que, por sua vez, converte o conteúdo dos dados
 * encontrados em cfg.data em JSON para que posteriormente possam ser repassados
 * pelo Ajax a partir de um pedido HTTP. Notem também a chamada à função
 * isObject(cfg.data) que repassa como parâmetro cfg.data para saber se os dados
 * apontados por cfg tratam-se de um array de dados, ou se é um objeto simples,
 * criado como {} ou new Object e por último verifica se trata-se de uma função
 * objeto Javascrit.
 */
 ...
 * verifica se trata-se de uma função objeto Javascrit.Retorna o tipo estrutura
 * passada pelo objeto cfg.
 */
function isObject(o) {
...
SENAI.ajax.post = function(cfg) {
	 ...
	 * valores, se isto se confirmar retorna o objeto cfg e o armazena também em
	...
	/*
	 *(merge) Fundindo os objetos def e cfg e armazenando seus respectivos valores em
	 * config.
	 */
